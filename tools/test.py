...
@contextmanager
def maybe_profile(use_profile=False):
    if not use_profile:
        yield
    else:
...
def parse_args():
    ...
    if args.extra_tag == 'debug':
        # args.config = '../configs/centernet/centernet_resnet18_140e_coco.py'
        # args.checkpoint = 'output/centernet/ckpt/centernet_resnet18_140e_coco_20210519_092334-eafe8ccd.pth'
...
def main():
    ...
    if not distributed:
        ...
        with maybe_profile(args.use_profile):
